        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 max-w-4xl mx-auto text-lg text-gray-700 leading-relaxed">
          <div className="flex flex-col lg:flex-row items-center gap-10 mb-12">
            <div className="lg:w-1/2">
              ...
              <p className="mb-4">
                Barizaloka Group berawal dari visi seorang pemuda di sebuah desa
                kecil di Rembang. Melihat begitu banyak potensi lokal, terutama
                UMKM, yang belum tergarap di dunia digital, ia merasakan adanya
                peluang besar untuk membuat perubahan.
              </p>
              <p>
                Dengan keyakinan bahwa teknologi dapat menjadi jembatan menuju
                kemajuan, ia berkomitmen untuk membangun sebuah layanan yang
                tidak hanya menyediakan website, tetapi juga memberdayakan
                bisnis-bisnis kecil untuk berkembang dan menjangkau pasar yang
                lebih luas.
              </p>
            </div>
          ...
          <div className="border-t border-gray-200 pt-8 mt-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p>
                  Menjadi mitra terpercaya bagi UMKM di Indonesia dalam
                  mewujudkan transformasi digital yang berkelanjutan dan berdaya
                  saing global.
                </p>
              </div>
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600">
                  <li>
                    Menyediakan layanan pengembangan website dan aplikasi yang
                    terjangkau dan berkualitas tinggi.
                  </li>
                  <li>
                    Memberikan edukasi dan bimbingan teknologi kepada pelaku
                    UMKM.
                  </li>
                  <li>
                    Membangun komunitas digital yang saling mendukung dan
                    berinovasi.
                  </li>
                </ul>
              </div>
